...
bot_info = 'Este bot esta usando <a href="https://github.com/Steffo99/greed">3be-telegram</a>,' \
           ' um framework criado por @Steffo para pagamentos no Telegram sob licença  ' \
           ' <a href="https://github.com/Steffo99/greed/blob/master/LICENSE.txt">' \
           'Affero General Public License 3.0</a>.\n'

# Help: guide
help_msg = "O guia de 3be-telegram esta dispovivel no endereço:\n" \
