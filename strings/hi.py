...
conversation_after_start = "नमस्ते!\n" \
                           "3be-telegram में आपका स्वागत है!\n" \
...
bot_info = 'यह बॉट <a href="https://github.com/Steffo99/greed">3be-telegram</a> का उपयोग कर रहा है,' \
...
# Help: guide
help_msg = "3be-telegram का मार्गदर्शन इस पते पर उपलब्ध है:\n" \
