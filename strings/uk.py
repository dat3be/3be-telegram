...
bot_info = 'Цей бот використовує <a href="https://github.com/Steffo99/greed">3be-telegram</a>,' \
           ' фреймворк розроблений @Steffo для платежів Телеграм випущений під ліцензією' \
           ' <a href="https://github.com/Steffo99/greed/blob/master/LICENSE.txt">' \
           'Affero General Public License 3.0</a>.\n'

# Help: guide
help_msg = "Інструкція по 3be-telegram доступна за цією адресою:\n" \
