...
bot_info = 'Este bot está usando <a href="https://github.com/Steffo99/greed">3be-telegram</a>,' \
           ' un framework creado por @Steffo para pagos a través de Telegram lanzado bajo la licencia:' \
           ' <a href="https://github.com/Steffo99/greed/blob/master/LICENSE.txt">' \
           'Affero General Public License 3.0</a>.\n'

# Help: guide
help_msg = "La guía de 3be-telegram está disponible en este enlace:\n" \
