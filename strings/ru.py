# Strings / localization file for 3be-telegram
...
conversation_after_start = "Привет!\n" \
                           "Добро пожаловать в 3be-telegram!\n" \
...
bot_info = 'Этот бот использует <a href="https://github.com/Steffo99/greed">3be-telegram</a>,' \
           ' фреймворк разработан @Steffo для платежей Телеграм и выпущен под лицензией' \
           ' <a href="https://github.com/Steffo99/greed/blob/master/LICENSE.txt">' \
           'Affero General Public License 3.0</a>.\n'

# Help: guide
help_msg = "Инструкция к 3be-telegram доступна по этому адресу:\n" \
